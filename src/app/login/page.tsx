    ...
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto pt-20">
      ...
      <form className="animate-in flex-1 flex flex-col w-full justify-center gap-2 text-foreground">
        <div className="mb-8">
          ...
          <p className="text-text-secondary text-sm">Sign in to NodeFlux to continue.</p>
        </div>
        ...
        <div className="text-center mt-4">
          ...
          <Link href="/register" className="text-accent-http hover:underline text-sm font-medium">
            Sign up
          </Link>
        </div>
