...
create policy "Users can view their own workflow_runs"
  on workflow_runs for select
  using (auth.uid() = user_id);

create policy "Users can create their own workflow_runs"
  on workflow_runs for insert
  with check (auth.uid() = user_id);

create policy "Users can update their own workflow_runs"
